...
namespace GMM_FIELD
{
    class orientud
    {
        ...
        double delta;
        public orientud(double BETAMI, double BETAMX, double THETMI, double THETMX, double PHIMIN, double PHIMAX, int NBETA, int NTHETA, int NPHI, double[] BETA, double[] THETA, double[] PHI)
        {
            this.BETAMI = BETAMI;
            this.BETAMX = BETAMX;
            this.THETMI = THETMI;
